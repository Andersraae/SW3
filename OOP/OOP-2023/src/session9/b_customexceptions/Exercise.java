...
/*
    ...
    Requirements:
    1. Define a custom exception class NegativeDepositException that extends Exception.
    2. Define another custom exception class WarningLargeDeposit that also extends Exception
       and includes:
